...
INCLUDES=-I utils -I parsing -I typing -I bytecomp -I middle_end \
         ...
         -I supportlibs/dwarf_high -I supportlibs/dwarf_low \
         -I driver -I toplevel
...
ARCH_SPECIFIC_ASMCOMP_EARLY=
ARCH_SPECIFIC_ASMCOMP=
ifeq ($(ARCH),i386)
ARCH_SPECIFIC_ASMCOMP_EARLY=asmcomp/x86_proc.cmo
...
DWARF_LOW=\
  supportlibs/dwarf_low/dwarf_format.cmo \
  supportlibs/dwarf_low/dwarf_format_int.cmo \
  supportlibs/dwarf_low/dwarf_value.cmo \
  supportlibs/dwarf_low/dwarf_version.cmo \
  supportlibs/dwarf_low/initial_length.cmo \
  supportlibs/dwarf_low/child_determination.cmo \
  supportlibs/dwarf_low/dwarf_tag.cmo \
  supportlibs/dwarf_low/dwarf_operator.cmo \
  supportlibs/dwarf_low/simple_location_description.cmo \
  supportlibs/dwarf_low/composite_location_description.cmo \
  supportlibs/dwarf_low/single_location_description.cmo \
  supportlibs/dwarf_low/dwarf_attributes.cmo \
  supportlibs/dwarf_low/encoding_attribute.cmo \
  supportlibs/dwarf_low/dwarf_attribute_values.cmo \
  supportlibs/dwarf_low/abbreviation_code.cmo \
  supportlibs/dwarf_low/abbreviations_table_entry.cmo \
  supportlibs/dwarf_low/abbreviations_table.cmo \
  supportlibs/dwarf_low/debugging_information_entry.cmo \
  supportlibs/dwarf_low/aranges_table.cmo \
  supportlibs/dwarf_low/location_list_entry.cmo \
  supportlibs/dwarf_low/location_list.cmo \
  supportlibs/dwarf_low/debug_info_section.cmo \
  supportlibs/dwarf_low/debug_loc_table.cmo

DWARF_HIGH=\
  supportlibs/dwarf_high/proto_die.cmo \
  supportlibs/dwarf_high/dwarf_attribute_helpers.cmo \
  supportlibs/dwarf_high/assign_abbrevs.cmo \
  supportlibs/dwarf_high/dwarf_world.cmo

ASMCOMP=\
  $(ARCH_SPECIFIC_ASMCOMP_EARLY) \
  asmcomp/arch.cmo asmcomp/ident_ibp.cmo \
  ...
  asmcomp/printmach.cmo asmcomp/debug/name_laundry.cmo \
  asmcomp/selectgen.cmo asmcomp/spacetime_profiling.cmo \
  ...
  asmcomp/deadcode.cmo asmcomp/linearize.cmo \
  asmcomp/debug/coalesce_labels.cmo \
  asmcomp/debug/available_regs.cmo asmcomp/debug/available_filtering.cmo \
...
partialclean::
	for d in utils parsing typing bytecomp asmcomp asmcomp/debug middle_end \
                 supportlibs/dwarf_high supportlibs/dwarf_low \
