...
CAMLOPT=$(CAMLRUN) ./ocamlopt -nostdlib -I stdlib -I otherlibs/dynlink -g
COMPFLAGS=-strict-sequence -w +33..39+48+50 -warn-error A -bin-annot \
          -safe-string $(INCLUDES)
LINKFLAGS=-cclib -export-dynamic -g
...
depend: beforedepend
	(for d in utils parsing typing bytecomp asmcomp driver toplevel asmcomp/dwarf_low; \
