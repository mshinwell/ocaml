...
partialclean::
	for d in utils parsing typing bytecomp asmcomp asmcomp/dwarf_high \
		 asmcomp/dwarf_low middle_end middle_end/base_types driver \
		 toplevel tools; \
...
depend: beforedepend
	(for d in utils parsing typing bytecomp asmcomp asmcomp/dwarf_high \
	 asmcomp/dwarf_low middle_end middle_end/base_types driver toplevel; \
