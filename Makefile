...
partialclean::
	for d in utils parsing typing bytecomp asmcomp asmcomp/debug \
                 supportlibs/dwarf_high \
		 supportlibs/dwarf_low middle_end middle_end/base_types driver \
		 toplevel tools; \
...
depend: beforedepend
	(for d in utils parsing typing bytecomp asmcomp asmcomp/debug \
         supportlibs/dwarf_high \
	 supportlibs/dwarf_low middle_end middle_end/base_types driver toplevel; \
