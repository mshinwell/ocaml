...
module type S = sig
  ...
  module rec T : (Typing_world_types.Types_nonrec_with_abstract_flambda_types
      with module Abstract_types := T
      and module Abstract_functor_types := Functor_T
      with module Flambda_types = Flambda_types)
  and Functor_T : (Typing_world_types.Functor_types_nonrec
      with module Abstract_types := T)
  ...
  and Discriminants : (Discriminants_intf.S
    with module T := T
    and module Functor_T := Functor_T)
  ...
  and Immediates : (Immediates_intf.S
    with module T := T
    and module Functor_T := Functor_T)
