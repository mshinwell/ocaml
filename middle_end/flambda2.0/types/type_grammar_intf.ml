...
module type S = sig
  ...
  type function_declaration_type
  type meet_env
  type typing_env
  ...
  val exactly_this_closure
     : Closure_id.t
    -> all_function_decls_in_set:function_declaration_type Closure_id.Map.t
  ...
  val expand_head : t -> typing_env -> resolved_type

  (** Greatest lower bound of two types. *)
  val meet : meet_env -> t -> t -> t * typing_env_extension
