...
struct
  ...
  module T_V_meet_or_join = T.T_V_ops.Make_meet_or_join (E)
  module T_Nf_meet_or_join = T.T_Nf_ops.Make_meet_or_join (E)
  module T_N32_meet_or_join = T.T_N32_ops.Make_meet_or_join (E)
  module T_N64_meet_or_join = T.T_N64_ops.Make_meet_or_join (E)
  module T_NN_meet_or_join = T.T_NN_ops.Make_meet_or_join (E)
