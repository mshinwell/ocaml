...
val object_file_format_and_abi : object_file_format_and_abi

(** Whether the target system is a Linux platform. *)
val linux : bool

(** Whether the target system is a Linux platform using the ELF binary format. *)
val linux_elf : bool
...
val machine_width : machine_width
