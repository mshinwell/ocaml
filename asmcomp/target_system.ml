...
let system = fst system_and_object_file_format_and_abi
let object_file_format_and_abi = snd system_and_object_file_format_and_abi
...
let linux_elf =
  linux &&
    match object_file_format_and_abi with
    | ELF _ -> true
    | _ -> false
