...
let nopervasives_attribute attr =
  clflags_attribute_without_payload attr
    ~name:"nopervasives" Clflags.nopervasives
...
let parse_early_interface_attributes attr =
  nopervasives_attribute attr

let parse_standard_interface_attributes attr =
  warning_attribute attr;
  nolabels_attribute attr

let parse_early_implementation_attributes attr =
  nopervasives_attribute attr
