...
struct
  let list = [
    ...
    mk_no_strict_formats F._no_strict_formats;
    mk_thread F._thread;
    mk_treat_invalid_code_as_unreachable F._treat_invalid_code_as_unreachable;
    mk_no_treat_invalid_code_as_unreachable F._no_treat_invalid_code_as_unreachable;
